...
This is the persistence backbone for the iterative binder-design workflow
(target_intel -> interface -> trim -> ... -> binder_scoring, with GPU
campaigns and design-pilot iterations modelled as rounds), and it also
...
SHARED_KINDS = ("structures", "ligands")
